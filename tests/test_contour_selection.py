...
def test_a_sparse_subject_stops_below_the_ceiling():
    """The sun is a disc and its rays: selection stops on marginal value well
    before the 24-stroke ceiling, although candidates remain."""
    _, candidates, sel = _selection("animals/sun.png")
