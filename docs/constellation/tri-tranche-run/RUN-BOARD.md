...
|---|---|---|---|---|---|
| **S1** | keyframes-D+E | keyframes D · **E IMPL+CLOSED** | D.W1–W4 GREEN · **E IMPL+CLOSED [fe9b120]** · D.W5+close gated on E1 | **E IMPL+CLOSED / READY-TO-PUBLISH** — `tranche-e-impl` (off D HEAD): all 11 E impl waves + close landed [391533e W1·W2·W3 · a7f6746 W7·W5 · 050204f W8 · 4ee8e34 W9·W10 · d400591 W11 · 663805e W4 · fe9b120 W6-close]. **460 tests · `proof:all` PASS** (13 proof gates + suite · tsc clean · inv α boundary holds). LANDED: demo encapsulation r2 · the vueuse listener gestalt (allowlist EMPTY, inv κ) · styling r2 (inv λ) · **5 engine correctness bugs test-locked** [colorSpace re-derive · createFrame index · WAAPI guard · WAAPI commit-on-finish · linear() read-back] (inv ν) · standalone zero-alloc · FrameCompiler determinism (content-derived frameId) + editor single-compile · platform adoption [@property·live-PRM·dense-WAAPI·additive-native-scroll] (inv ξ) · **the orchestration tier** [stagger/flip/drag/decay/Sequence/animate/fromDuration — NEW additive public API, barrel-wired, proof:boundary holds] · demo elevation [VT·a11y·idiom-r3·first-paint·CWV] (inv ο). Measure-first WITHHELD (honest, not punts): W7 Strand-B micro-perf · W8 SoA+incremental · tryParseCache · lighthouse-off-CI. value.js needs-handoff (W9 S4/S6 native-color/currentColor) → `valuejs-sota-handoff.md`. **E changeset `minor`** (additive API) atop B+C+D stack, owner Mike Babb. REMAINING: D.W5+W6 HARD-gated on **E1** (glass-ui 3.3.0); heartbeat-polling. Publish legs user-domain | 2026-06-05 |
